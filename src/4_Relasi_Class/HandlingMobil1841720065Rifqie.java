public class HandlingMobil1841720065Rifqie {
    ...
    public HandlingMobil1841720065Rifqie() {
    }

    public HandlingMobil1841720065Rifqie(String FrontSuspension, String RearSuspension, String Brakes, String Tyres, int Weight) {
