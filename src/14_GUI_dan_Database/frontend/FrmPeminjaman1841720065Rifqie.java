...
public class FrmPeminjaman1841720065Rifqie extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720065Rifqie() {
        initComponents();
        tampilData();
        kosongkanForm();
    }
    ...
    public void tampilData() {
        String[] kolom = {"ID", "Peminjam", "Judul Buku1841720065Rifqie", "TanggalPinjam", "Tanggal Kembali"};
        ArrayList<Peminjaman1841720065Rifqie> list = new Peminjaman1841720065Rifqie().getAllRifqie();
        Object[] rowData = new Object[5];

        this.tblPeminjaman.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getmIdpeminjamanRifqie();
            rowData[1] = list.get(i).getmAnggotaRifqie().getmNamaRifqie();
            rowData[2] = list.get(i).getmBukuRifqie().getmJudulRifqie();
            rowData[3] = list.get(i).getmTanggalPinjamRifqie();
            rowData[4] = list.get(i).getmTanggalKembaliRifqie();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Peminjaman1841720065Rifqie pinjam = new Peminjaman1841720065Rifqie().getByIdRifqie(Integer.parseInt(this.txtId.getText()));
        pinjam.setmAnggotaRifqie(new Anggota1841720065Rifqie().getByIdRifqie(Integer.parseInt(this.txtIdAnggota.getText())));
        pinjam.setmBukuRifqie(new Buku1841720065Rifqie().getByIdRifqie(Integer.parseInt(this.txtIdBuku.getText())));
        pinjam.setmTanggalPinjamRifqie(this.txtTanggalPinjam.getText());
        pinjam.setmTanggalKembaliRifqie(this.txtTanggalKembali.getText());
        pinjam.saveRifqie();
        tampilData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720065Rifqie pinjam = new Peminjaman1841720065Rifqie().getByIdRifqie(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pinjam.deleteRifqie();
        kosongkanForm();
        tampilData();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        ...
        pinjam.cariAnggotaRifqie(Integer.parseInt(this.txtIdAnggota.getText()));
        this.jLabel6.setText((pinjam.getmAnggotaRifqie().getmNamaRifqie()));
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBukuActionPerformed
        // TODO add your handling code here:
        Peminjaman1841720065Rifqie pinjam = new Peminjaman1841720065Rifqie();
        pinjam.cariBukuRifqie(Integer.parseInt(this.txtIdBuku.getText()));
        this.jLabel7.setText((pinjam.getmBukuRifqie().getmJudulRifqie()));
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = this.tblPeminjaman.getSelectedRow();
        Peminjaman1841720065Rifqie pinjam = new Peminjaman1841720065Rifqie().getByIdRifqie(Integer.parseInt(model.getValueAt(row, 0).toString()));
        this.txtId.setText(String.valueOf(pinjam.getmIdpeminjamanRifqie()));

        this.txtIdAnggota.setText(String.valueOf(pinjam.getmIdanggotaRifqie()));
        this.txtIdBuku.setText(String.valueOf(pinjam.getmIdbukuRifqie()));

        this.txtTanggalPinjam.setText(String.valueOf(pinjam.getmTanggalPinjamRifqie()));

        this.txtTanggalKembali.setText(String.valueOf(pinjam.getmTanggalKembaliRifqie()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720065Rifqie().setVisible(true);
            }
        });
    }
